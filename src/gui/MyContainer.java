...
public class MyContainer extends JPanel {
    ...
    public void setShowMenu() {
        ...
        GameSound.getIstance().getSound(GameSound.MENU).loop();
    }

    public void setShowPlay() {
        mCardLayout.show(MyContainer.this, TAG_PLAYGAME);
        mPlayGame.requestFocus();
        GameSound.getIstance().getSound(GameSound.MENU).stop();
        GameSound.getIstance().getSound(GameSound.PLAYGAME).loop();
    }
